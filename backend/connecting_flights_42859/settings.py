"""
Django settings for connecting_flights_42859 project.
...
ROOT_URLCONF = 'connecting_flights_42859.urls'
...
WSGI_APPLICATION = 'connecting_flights_42859.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connecting_flights_42859 API",
    "DESCRIPTION": "API documentation for connecting_flights_42859 App",
    "VERSION": "v1",
}
