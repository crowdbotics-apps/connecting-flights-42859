...
## Project Structure
    ...
    ├── connecting_flights_42859  # Django project configurations
...
1. Clone this repo and `cd connecting_flights_42859`
...
2. Clone this repo and `cd connecting_flights_42859`
